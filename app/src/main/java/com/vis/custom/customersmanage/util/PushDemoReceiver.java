...
import com.vis.custom.customersmanage.view.GetuiActivity;
        ...
        switch (bundle.getInt(PushConsts.CMD_ACTION)) {
            case PushConsts.GET_MSG_DATA:
                ...
                if (payload != null) {
                    ...
                    if (GetuiActivity.tLogView != null) {
                        GetuiActivity.tLogView.append(data + "\n");
                    }
                }
                break;
            ...
            case PushConsts.GET_CLIENTID:
                ...
                if (GetuiActivity.tView != null) {
                    GetuiActivity.tView.setText(cid);
                }
                break;
