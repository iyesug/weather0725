package com.vis.weather.update.download.network;

import android.support.annotation.NonNull;
import android.util.Log;
import com.vis.weather.update.download.network.download.DownloadProgressInterceptor;
import com.vis.weather.update.download.network.download.DownloadProgressListener;
import com.vis.weather.update.download.network.exception.CustomizeException;
import com.vis.weather.update.download.utils.FileUtils;
